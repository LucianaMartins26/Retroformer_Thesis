    ...
    for epoch in range(args.max_epoch):
        for batch in progress_bar:
            ...
            if (src_max_length + tgt_max_length) * entry_count < args.batch_size_token:
                ...
                csv_file_name = f'log_training_file_retroformer_readretro_{args.max_epoch}_epochs.csv'
...
if __name__ == '__main__':
    ...
    args.checkpoint_dir = f'../checkpoint_untyped_{device.replace(":", "")}_{args.max_epoch}_epochs'
